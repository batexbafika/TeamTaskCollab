# Task & Team Collaboration System
...
### Backend/API Developer (Technical Lead) — *Ntoh Batex Bafika*
...
### HTML + CSS Team (Combined Role) — *njeko catherine + Yannick(optional)*
- Semantic HTML structuring  
- Custom CSS styling  
- Mobile-first responsiveness (`@media` queries)  
- Basic Bootstrap (minimum styling only)  
...
- Commit messages should follow **Conventional Commits** style (e.g., `feat:`, `fix:`, `chore:`).  
- Documentation updates are mandatory for new features.  
...
- Final merged branch (`main`) with complete system functionality  
